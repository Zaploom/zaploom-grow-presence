...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-500">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-16 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 relative overflow-hidden">
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight text-gray-900 dark:text-white">
              About <span className="text-zaploom dark:text-zaploom-light">Zaploom</span>
            </h1>
        ...
        <div className="absolute top-0 right-0 w-64 h-64 bg-zaploom/5 dark:bg-zaploom-light/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-zaploom/5 dark:bg-zaploom-light/5 rounded-full blur-3xl"></div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              <div className="relative h-full flex items-center justify-center">
                <div className="absolute w-64 h-64 bg-zaploom/10 dark:bg-zaploom-light/10 rounded-full blur-xl"></div>
                <div className="relative z-10 bg-white dark:bg-gray-900 p-3 rounded-xl shadow-xl rotate-3 transform hover:rotate-0 transition-transform duration-300">
                  <img 
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div 
                key={index}
                className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 text-center"
              >
                <div className="inline-block p-4 bg-zaploom/5 dark:bg-zaploom-light/5 rounded-full mb-6">
                  {value.icon}
                </div>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index}
                className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300"
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-zaploom dark:text-zaploom-light mb-4">{member.position}</p>
              ...
              <div key={index} className="mb-12 relative">
                <div className="flex">
                  <div className="flex flex-col items-center mr-6">
                    <div className="w-12 h-12 bg-zaploom dark:bg-zaploom-light text-white rounded-full flex items-center justify-center font-bold text-lg">
                      {item.year}
                    </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="relative">
                <div className="absolute -left-6 -top-6 w-48 h-48 bg-zaploom/5 dark:bg-zaploom-light/5 rounded-full blur-xl"></div>
                <img
            ...
            <div>
              ...
              <div className="mb-6">
                <div className="flex items-center mb-4">
                  <BookOpen className="h-6 w-6 text-zaploom dark:text-zaploom-light mr-3" />
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white">Empowering Digital Growth</h3>
                </div>
                <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
