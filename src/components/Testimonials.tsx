...
const Testimonials = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-zaploom text-white">
      <div className="container-custom">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-sm p-8 rounded-lg flex-1 h-full">
              <svg
              ...
              <p className="text-lg mb-6 italic text-left">{testimonial.quote}</p>
